...
#     B.  Holt's Model (Exponential Smoothing w Trend)
#     C.  Holt-Winter's Model (Holt's Model w Seasonality)
...
autoplot(aug_SES, Sales) +
  ...
  autolayer(aug_SES,.resid, colour = "Blue")
#
#
...
sd(ASts$Sales)
accuracy(fit_ASts_tr)/sd(ASts$Sales)
#
#
